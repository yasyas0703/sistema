...
const fs = require('fs');
const bcrypt = require('bcryptjs'); // necessário para createInitialData
...
// 👉 Adiciona coluna cadastrada à tabela empresas
await db.runAsync(`
  ALTER TABLE empresas ADD COLUMN cadastrada BOOLEAN DEFAULT TRUE
`).catch(() => {
  console.log('ℹ️ Coluna cadastrada já existe em empresas.');
});
